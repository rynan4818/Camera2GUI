...
JSON_FILE_SAVE_DEL_ERR_MES           = "カメラファイルの削除ができません。"
JSON_FILE_SAVE_DEL_ERR_TITLE         = "ファイル削除エラー"
ALL_JSON_FILE_SAVE_TITLE             = "現在の全カメラとシーン設定を1つのJSONファイルに保存します"
ALL_JSON_FILE_LOAD_TITLE             = "全カメラとシーン設定を保存したJSONファイルから読み込みます。Camera2に反映するには読み込んだ後にSAVEが必要です。"
